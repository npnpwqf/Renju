...
class CallTraceback_OriginIdToStringEntry;
class CallTraceback_OriginIdToStringEntryDefaultTypeInternal;
extern CallTraceback_OriginIdToStringEntryDefaultTypeInternal _CallTraceback_OriginIdToStringEntry_default_instance_;
class EventReply;
...
class CallTraceback : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.CallTraceback) */ {
 public:
  ...
  inline CallTraceback* New() const PROTOBUF_FINAL { return New(NULL); }

  CallTraceback* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  public:
  class CallTraceback_OriginIdToStringEntry : public ::google::protobuf::internal::MapEntry<CallTraceback_OriginIdToStringEntry, 
      ::google::protobuf::int64, ::std::string,
      ::google::protobuf::internal::WireFormatLite::TYPE_INT64,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      0 > {
  public:
    typedef ::google::protobuf::internal::MapEntry<CallTraceback_OriginIdToStringEntry, 
      ::google::protobuf::int64, ::std::string,
      ::google::protobuf::internal::WireFormatLite::TYPE_INT64,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      0 > SuperType;
    CallTraceback_OriginIdToStringEntry();
    CallTraceback_OriginIdToStringEntry(::google::protobuf::Arena* arena);
    void MergeFrom(const ::google::protobuf::Message& other) PROTOBUF_FINAL;
    void MergeFrom(const CallTraceback_OriginIdToStringEntry& other);
    static const Message* internal_default_instance() { return reinterpret_cast<const Message*>(&_CallTraceback_OriginIdToStringEntry_default_instance_); }
...
inline void CallTraceback::clear_origin_stack() {
...
inline void CallTraceback::clear_graph_traceback() {
...
template <> struct is_proto_enum< ::tensorflow::CallTraceback_CallType> : ::google::protobuf::internal::true_type {};
template <>
